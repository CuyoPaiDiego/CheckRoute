...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary" >
        <div class="container-fluid">
          <a class="navbar-brand h5" href="multas.php">Multas</a>
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary" >
        <div class="container-fluid">
          <a class="navbar-brand h5" href="multas.php">Insertar multa</a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active h6" aria-current="page" href="Index.html">Modificar multa</a>
              </li>
              <li class="nav-item">
                <a class="nav-link h6" href="crearHorario.php">Eliminar multa</a>
              </li>
      ...
      <table class="table">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $sql = "INSERT idmultas, unidad, fecha, estadoMulta
          FROM multas
